          ...
          <div className="space-y-8">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://linkedin.com/in/edwardlin43" target="_blank" className="text-primary">LinkedIn</a>
              </div>

              <div className="flex space-x-4 justify-center">
                <a href="https://instagram.com/edwardlin43" target="_blank" className="text-primary">Instagram</a>
              </div>
